                    ...
                    <table id="myTable" class="display border" >
                        ...
                        @foreach($Datakey as $data)
                            <tr>
                                ...
                                <td><a data-fancybox data-type="iframe" href="{{asset('/')}}/public/upload/image/cultivation/classRoutine/{{ $data->attachment }}" target="_blank"> <i class="fa fa-eye" style="color: green;"></i> </a></td>
                            </tr>  
                        @endforeach         
                        </tbody>
                    </table>                         
