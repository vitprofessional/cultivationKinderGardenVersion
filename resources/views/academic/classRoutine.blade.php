                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('editClassRoutine',['id'=>$item->id]) }}"><i class="fa-light fa-pen-to-square fa-xl"></i></a>
                                    <a href="{{ route('delClassRoutine',['id'=>$item->id]) }}" onclick="return confirm('Are you sure to delete?')"><i class="fa-thin fa-circle-trash fa-xl"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        @else
