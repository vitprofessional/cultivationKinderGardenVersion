...
@php 
    ...
    if(!empty($itemId)):
        $items       = \App\Models\Syllabus::find($itemId);
        if(!empty($items)): 
            $title              = $items->title;
...
<div class="row gutters-20 mb-4">
    <div class="col-10 mx-auto">
        <div class="card">
            <div class="card-header">Syllabus Management</div>
            <div class="card-body cultivation">
                ...
                <form action="{{ route('saveSyllabus') }}" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Enter the title of the syllabus" value="{{ $title }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @if(!empty($attachment))
                        <div>
                            <iframe src="{{ asset('public/upload/image/cultivation/syllabus/').'/'.$attachment }}" class="w-25" height="300px"></iframe>
                            <a href="{{ route('delSyllabusContent',['id'=>$itemId]) }}" class="fw-bold text-danger">Delete</a>
                        </div>
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <a class="btn btn-primary btn-lg mx-2" href="{{ route('syllabusManage') }}">New Syllabus</a>
                    </div>
                </form>
            </div>
